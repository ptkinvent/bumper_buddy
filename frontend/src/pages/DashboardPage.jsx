...
export default function DashboardPage() {
  ...
  const filteredClaims = claims.filter((claim) => claim.authorId === user.id || claim.reviewerId === user.id);
  ...
  const stats = [
    {
      name: "Author",
      value: filteredClaims.filter((claim) => claim.authorId === user.id).length,
      color: "blue",
    },
    {
      name: "Reviewer",
      value: filteredClaims.filter((claim) => claim.reviewerId === user.id).length,
      color: "yellow",
    },
  ];
